    ...
    <div class="row">
        <div class="col-md-12">
            <div class="btn-group fa-pull-left">
                <a href="#" class="btn btn-outline-dark" data-action="switch" data-switch="inactive" data-link="{{ route('sales') }}" title="Switch to non-active contracts"><i class="fas fa-exchange-alt"></i>  Inactive</a>
