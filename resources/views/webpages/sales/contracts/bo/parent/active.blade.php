    ...
    <div class="row">
        <div class="col-md-12">
            <div class="btn-group fa-pull-left">
                <a href="#" class="btn btn-outline-dark" data-action="switch" data-switch="inactive_parent" data-link="{{ route('sales') }}" title="Switch to non-active parent contracts"><i class="fas fa-exchange-alt"></i>  Inactive</a>
                <a href="{{ route('sales') }}" class="btn btn-outline-dark" id="sales" title="Switch to normal contracts" navigation><i class="fas fa-folder"></i>  Normal</a>
                <a href="#" class="btn btn-outline-dark" data-action="switch" data-switch="child_bo" data-link="{{ route('sales') }}" title="Switch to Child BO"><i class="fas fa-folder-minus"></i>  Child BO</a>
            </div>
        </div>
    </div>
    <div class="my-3"></div>
            ...
            <form id="add-sales-breakdown-form" data-form="Sales Breakdown" data-request="add" action="{{ route('sales.store') }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="sale_amount" name="amount" class="form-control" placeholder="Amount" min="0" step=".01">
                    </div>
                    <div class="form-group">
                        <input type="text" id="sale_gross_amount" name="gross_amount" class="form-control" value="Gross Amount" readonly min="0" step=".01">
                    </div>
                </div>
