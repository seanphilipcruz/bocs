    ...
    <div class="row">
        <div class="col-md-12">
            <div class="btn-group fa-pull-left">
                <a href="#" class="btn btn-outline-dark" data-action="switch" data-switch="child_bo" data-link="{{ route('contracts') }}" title="Switch to Active Child BO"><i class="fas fa-exchange-alt"></i>  Active</a>
            </div>
...
<script type="text/javascript">
    ...
    $(document).on('change', '#filter_contract', function() {
        ...
        window.history.pushState("", "", "/contracts/bo/child/inactive/filter/"+year);
