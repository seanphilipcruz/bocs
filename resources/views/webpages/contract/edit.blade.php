        ...
        <div class="col-md-12">
            <div class="fa-pull-left">
                ...
                @elseif($contract->is_active === 1 && $contract->bo_type === "parent")
                    <a href="#" class="btn btn-outline-dark" data-action="switch" data-switch="parent" data-link="{{ route('contracts') }}" title="Back to Parent BO"><i class="fas fa-arrow-left"></i>  Back</a>
                @elseif($contract->is_active === 1 && $contract->bo_type === "child")
                    <a href="#" class="btn btn-outline-dark" data-action="switch" data-switch="child_bo" data-link="{{ route('contracts') }}" title="Back to Child BO"><i class="fas fa-arrow-left"></i>  Back</a>
