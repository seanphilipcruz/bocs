...
class CreateSalesArchiveTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sales_revisions', function (Blueprint $table) {
            ...
            $table->string('version')->nullable(2);
            $table->timestamps();
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('sales_revisions');
    }
}
